...
class CAS(unittest.TestCase):
    ...
    def test_024_validate_radius_accounting_tcpdump(self):
        ...
        output = child.before
        print("#####OUTPUT#####",output)
        if re.search(r".*10.197.38.101.radius-acct.*Accounting-Response.*",output):
            assert True
            child.close()
        else:
            assert False
    ...
    def test_039_validate_tacacs_accounting_tcpdump(self):
        ...
        output = child.before
        print("#####OUTPUT#####",output)
        if re.search(r".*"+config.auth_server+".tacacs.*",output):
    ...
    def test_040_validate_tacacs_mgmt_interface_tcpdump(self):
        ...
        output = child.before
        print("#####OUTPUT#####",output)
        if re.search(r".*"+config.grid_vip+".*"+config.auth_server+".tacacs.*",output):
